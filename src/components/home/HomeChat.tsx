        ...
        {messages.length === 0 ? (
          ...
          messages.map(msg => (
            <div key={msg.id} className={cn("flex gap-2", msg.role === "user" ? "justify-end" : "justify-start")}>
              {msg.role === "assistant" && (
                <span className="text-[#2ec898] text-[8px] shrink-0 mt-1">◆</span>
              )}
              <div className={cn(
                ...
                {msg.role === "assistant" ? (
                  <div className="prose prose-invert prose-xs max-w-none
                    ...
                    [&_code]:bg-[#12121c] [&_code]:border [&_code]:border-[#1a1a28] [&_code]:px-1 [&_code]:rounded [&_code]:font-mono [&_code]:text-[10px] [&_code]:text-[#2ec898]
          ...
          {isStreaming ? (
            ...
            <button
              ...
              className={cn(
                ...
                input.trim()
                  ? "border-[#2ec89833] bg-[#2ec8980a] text-[#2ec898] hover:bg-[#2ec89818]"
