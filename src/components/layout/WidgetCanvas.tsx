...
// Catalog uses 40-col grid units (each unit = 30px)
const WIDGET_CATALOG: CatalogEntry[] = [
  { type: "candlestick",       label: "Price Chart",          desc: "OHLCV candlestick chart",              defaultW: 27, defaultH: 10 },
  { type: "rsi",               label: "RSI",                  desc: "Relative Strength Index",              defaultW: 13, defaultH: 6  },
  { type: "macd",              label: "MACD",                 desc: "Moving Average Convergence",           defaultW: 13, defaultH: 6  },
  { type: "stochastic",        label: "Stochastic",           desc: "Stochastic oscillator %K/%D",          defaultW: 13, defaultH: 6  },
  { type: "bollinger",         label: "Bollinger Bands",      desc: "Volatility bands",                     defaultW: 13, defaultH: 6  },
  { type: "ema",               label: "EMA Panel",            desc: "9/21/50/100/200 EMAs",                 defaultW: 20, defaultH: 6  },
  { type: "signal-summary",    label: "Signal Summary",       desc: "Aggregate buy/sell signals",           defaultW: 20, defaultH: 6  },
  { type: "adx",               label: "ADX / DMI",            desc: "Trend strength & direction",           defaultW: 13, defaultH: 6  },
  { type: "cci",               label: "CCI (20)",             desc: "Commodity Channel Index",              defaultW: 13, defaultH: 6  },
  { type: "psar",              label: "Parabolic SAR",        desc: "Stop-and-reverse reversal dots",       defaultW: 13, defaultH: 6  },
  { type: "obv",               label: "OBV",                  desc: "On-Balance Volume trend",              defaultW: 13, defaultH: 6  },
  { type: "key-metrics",       label: "Key Metrics",          desc: "P/E, EV/EBITDA, market cap",          defaultW: 13, defaultH: 6  },
  { type: "earnings",          label: "Earnings",             desc: "EPS history & estimates",              defaultW: 13, defaultH: 6  },
  { type: "news-feed",         label: "News Feed",            desc: "Latest news with sentiment",           defaultW: 13, defaultH: 8  },
  { type: "iv-rank",           label: "IV Rank",              desc: "Implied volatility rank",              defaultW: 13, defaultH: 6  },
  { type: "put-call-ratio",    label: "Put/Call Ratio",       desc: "Options sentiment ratio",              defaultW: 13, defaultH: 6  },
  { type: "options-chain",     label: "Options Chain",        desc: "Full calls/puts table",                defaultW: 27, defaultH: 12 },
  { type: "max-pain",          label: "Max Pain",             desc: "Max pain strike calculator",           defaultW: 13, defaultH: 6  },
  { type: "prob-cone",         label: "Probability Cone",     desc: "1σ/2σ price range at expiry",         defaultW: 13, defaultH: 6  },
  { type: "quality-score",     label: "Quality Score",        desc: "Business quality: margins, ROE, FCF",  defaultW: 13, defaultH: 8  },
  { type: "valuation-context", label: "Valuation Context",   desc: "Multiples vs own 1Y history",          defaultW: 13, defaultH: 8  },
  { type: "timeframe-heatmap", label: "Timeframe Heatmap",   desc: "1M–2Y agreement grid",                 defaultW: 27, defaultH: 8  },
  { type: "conviction-tracker",label: "Management Conviction",desc: "Insider buy/sell trend",               defaultW: 13, defaultH: 10 },
  { type: "narrative-index",   label: "Narrative Index",     desc: "News narrative lifecycle stage",       defaultW: 13, defaultH: 8  },
];
...
export default function WidgetCanvas() {
  ...
  const handleAddWidget = useCallback((entry: CatalogEntry) => {
    ...
    const widget: WidgetConfig = {
      ...
      minW: entry.type === "candlestick" || entry.type === "options-chain" ? 7 : 2,
      minH: 2,
    };
    addWidget(widget);
  }, [widgets, addWidget]);
