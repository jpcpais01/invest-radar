...
const CATALOG: CatalogEntry[] = [
  { type: "candlestick",        label: "Price Chart",           desc: "OHLCV candlestick chart",              defaultW: 4, defaultH: 4 },
  { type: "rsi",                label: "RSI",                   desc: "Relative Strength Index",              defaultW: 4, defaultH: 4 },
  { type: "macd",               label: "MACD",                  desc: "Moving Average Convergence",           defaultW: 4, defaultH: 4 },
  { type: "stochastic",         label: "Stochastic",            desc: "Stochastic oscillator %K/%D",          defaultW: 4, defaultH: 4 },
  { type: "bollinger",          label: "Bollinger Bands",       desc: "Volatility bands",                     defaultW: 4, defaultH: 4 },
  { type: "ema",                label: "EMA Panel",             desc: "9 / 21 / 50 / 100 / 200 EMAs",        defaultW: 4, defaultH: 4 },
  { type: "signal-summary",     label: "Signal Summary",        desc: "Aggregate buy / sell signals",         defaultW: 4, defaultH: 4 },
  { type: "adx",                label: "ADX / DMI",             desc: "Trend strength & direction",           defaultW: 4, defaultH: 4 },
  { type: "cci",                label: "CCI (20)",              desc: "Commodity Channel Index",              defaultW: 4, defaultH: 4 },
  { type: "psar",               label: "Parabolic SAR",         desc: "Stop-and-reverse reversal dots",       defaultW: 4, defaultH: 4 },
  { type: "obv",                label: "OBV",                   desc: "On-Balance Volume trend",              defaultW: 4, defaultH: 4 },
  { type: "key-metrics",        label: "Key Metrics",           desc: "P/E, EV/EBITDA, market cap",          defaultW: 4, defaultH: 4 },
  { type: "earnings",           label: "Earnings",              desc: "EPS history & estimates",              defaultW: 4, defaultH: 4 },
  { type: "news-feed",          label: "News Feed",             desc: "Latest news with sentiment",           defaultW: 4, defaultH: 4 },
  { type: "iv-rank",            label: "IV Rank",               desc: "Implied volatility rank",              defaultW: 4, defaultH: 4 },
  { type: "put-call-ratio",     label: "Put / Call Ratio",      desc: "Options sentiment ratio",              defaultW: 4, defaultH: 4 },
  { type: "options-chain",      label: "Options Chain",         desc: "Full calls / puts table",              defaultW: 4, defaultH: 4 },
  { type: "max-pain",           label: "Max Pain",              desc: "Max pain strike calculator",           defaultW: 4, defaultH: 4 },
  { type: "prob-cone",          label: "Probability Cone",      desc: "1σ / 2σ price range at expiry",       defaultW: 4, defaultH: 4 },
  ...
  { type: "timeframe-heatmap",  label: "Timeframe Heatmap",     desc: "1M – 2Y agreement grid",              defaultW: 4, defaultH: 4 },
  { type: "conviction-tracker", label: "Management Conviction", desc: "Insider buy / sell trend",            defaultW: 4, defaultH: 4 },
